...
## Assuming sys_clk_pin is the clock signal
#set_input_delay -clock sys_clk_pin 0 [get_ports {btn_tri_io}]
#set_input_delay -clock sys_clk_pin 0 [get_ports {rst_n}]

#set_output_delay -clock sys_clk_pin 0 [get_ports {hsync}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vsync}]

#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Blue[0]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Blue[1]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Blue[2]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Blue[3]}]

#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Green[0]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Green[1]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Green[2]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Green[3]}]

#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Red[0]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Red[1]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Red[2]}]
#set_output_delay -clock sys_clk_pin 0 [get_ports {vga_Red[3]}]

#set_property -dict {PACKAGE_PIN P5 IOSTANDARD LVCMOS33} [get_ports {sys_clk_pin}]
...
#set_property SEVERITY {Warning} [get_drc_checks Unbuffered_IO]
